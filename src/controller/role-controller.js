...
const getRole = async (req, res, next) => {
    try {
        ...
        const responses = new ResponseSuccess("Success get role", result).getResponse();
...
const updateRole = async (req, res, next) => {
    try {
        ...
        const responses = new ResponseSuccess("Success update role", result).getResponse();
...
const removeRole = async (req, res, next) => {
    try {
        ...
        const responses = new ResponseSuccess("Success remove role", result).getResponse();
...
const listRole = async (req, res, next) => {
    try {
        ...
        const responses = new ResponseSuccess("Success get list role", result).getResponse();
