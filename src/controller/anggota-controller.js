...
const createAnggota= async (req, res, next) => {
    try {
        ...
        const responses = new ResponseSuccess("Anggota registered", result).getResponse();
...
const getAnggota= async (req, res, next) => {
    try {
        ...
        const responses = new ResponseSuccess("Success get anggota", result).getResponse();
...
const updateAnggota= async (req, res, next) => {
    try {
        ...
        const responses = new ResponseSuccess("Success update anggota", result).getResponse();
...
const removeAnggota= async (req, res, next) => {
    try {
        ...
        const responses = new ResponseSuccess("Success remove anggota", result).getResponse();
...
const listAnggota= async (req, res, next) => {
    try {
        ...
        const responses = new ResponseSuccess("Success get list anggota", result).getResponse();
