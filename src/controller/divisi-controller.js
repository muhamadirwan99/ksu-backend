...
const getDivisi = async (req, res, next) => {
    try {
        ...
        const responses = new ResponseSuccess("Success get divisi", result).getResponse();
...
const updateDivisi = async (req, res, next) => {
    try {
        ...
        const responses = new ResponseSuccess("Success update divisi", result).getResponse();
...
const removeDivisi = async (req, res, next) => {
    try {
        ...
        const responses = new ResponseSuccess("Success remove divisi", result).getResponse();
...
const listDivisi = async (req, res, next) => {
    try {
        ...
        const responses = new ResponseSuccess("Success get list divisi", result).getResponse();
